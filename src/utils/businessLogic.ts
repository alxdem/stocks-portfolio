import { IStocksObject, ITikerListData, IPortfolioElement, OperationType } from '@models/common';
import { IOperation, IOperationBasic } from '@molecules/OperationCard/OperationCard.props';
